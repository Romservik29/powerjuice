...
export default function FinalScoreScreen({navigation}) {
    ...
    return (
        <Container color="orange">
            ...
            <Image source={require('../img/mother-happy.png')} style={{ width: 150, height: 150 }} />
                ...
                <MyButton width="150px" title={language.That_means[lang]} onPress={() => navigation.navigate("HomeScreen")} />
            </StoryContainer>
        </Container>
    )
}
